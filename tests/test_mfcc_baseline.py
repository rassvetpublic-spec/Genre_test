...
def test_backend_identity_is_versioned_and_audio_only() -> None:
    ...
    assert "mfcc20-dct2-ortho-lifter0-mels128-power2" in info.preprocessing_version
    assert "chroma12-contrast7-fmin200-quantile0.02-linear0" in info.preprocessing_version
    assert "meanstd-sr22050-mono-nfft2048-hop512" in info.preprocessing_version
