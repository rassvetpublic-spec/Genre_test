...
- [ ] Native DAW/Ozone WAV 48 kHz / 24-bit, Normalize Off.
- [ ] Если есть float winner: sample/null comparison выполнен; residual соответствует dither/noise floor.
...
- [ ] Пользователь слухом принял финал; backup назван.
